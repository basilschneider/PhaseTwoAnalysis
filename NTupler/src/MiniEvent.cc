...
void createMiniEventTree(TTree* t_tree_, MiniEvent_t &ev)
{
  ...
  //t_tree_->Branch("vld_el_good_abs", &ev.vld_el_good_abs);
  //t_tree_->Branch("vld_el_iso_rel", &ev.vld_el_iso_rel);
  //t_tree_->Branch("vld_el_good_rel", &ev.vld_el_good_rel);
  ...
  //t_tree_->Branch("vld_mu_good_abs", &ev.vld_mu_good_abs);
  //t_tree_->Branch("vld_mu_iso_rel", &ev.vld_mu_iso_rel);
  //t_tree_->Branch("vld_mu_good_rel", &ev.vld_mu_good_rel);
