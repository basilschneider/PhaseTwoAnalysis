...
void createMiniEventTree(TTree* t_tree_, MiniEvent_t &ev)
{
  ...
  //t_tree_->Branch("vld_el_tight_dxy", &ev.vld_el_tight_dxy);
  //t_tree_->Branch("vld_el_dz", &ev.vld_el_dz);
  //t_tree_->Branch("vld_el_tight_dz", &ev.vld_el_tight_dz);
  //t_tree_->Branch("vld_mu_iso_abs", &ev.vld_mu_iso_abs);
  //t_tree_->Branch("vld_mu_tight_iso_abs", &ev.vld_mu_tight_iso_abs);
  //t_tree_->Branch("vld_mu_iso_rel", &ev.vld_mu_iso_rel);
  //t_tree_->Branch("vld_mu_tight_iso_rel", &ev.vld_mu_tight_iso_rel);
  ...
  t_tree_->Branch("vld_el_tight_iso_pt", &ev.vld_el_tight_iso_pt);
  ...
  t_tree_->Branch("vld_el_tight_iso_hs_pt", &ev.vld_el_tight_iso_hs_pt);
  t_tree_->Branch("vld_el_py8_pt", &ev.vld_el_py8_pt);
  t_tree_->Branch("vld_el_tight_py8_pt", &ev.vld_el_tight_py8_pt);
  t_tree_->Branch("vld_el_tight_iso_py8_pt", &ev.vld_el_tight_iso_py8_pt);
  ...
  t_tree_->Branch("vld_el_tight_py8_eta", &ev.vld_el_tight_py8_eta);
  t_tree_->Branch("vld_el_tight_iso_py8_eta", &ev.vld_el_tight_iso_py8_eta);
  t_tree_->Branch("vld_el_others_eta", &ev.vld_el_others_eta);
  t_tree_->Branch("vld_el_tight_others_eta", &ev.vld_el_tight_others_eta);
  t_tree_->Branch("vld_el_tight_iso_others_eta", &ev.vld_el_tight_iso_others_eta);

  t_tree_->Branch("vld_mu_pt", &ev.vld_mu_pt);
  t_tree_->Branch("vld_mu_tight_pt", &ev.vld_mu_tight_pt);
  t_tree_->Branch("vld_mu_tight_iso_pt", &ev.vld_mu_tight_iso_pt);
  ...
  t_tree_->Branch("vld_mu_tight_iso_hs_pt", &ev.vld_mu_tight_iso_hs_pt);
  t_tree_->Branch("vld_mu_py8_pt", &ev.vld_mu_py8_pt);
  t_tree_->Branch("vld_mu_tight_py8_pt", &ev.vld_mu_tight_py8_pt);
  t_tree_->Branch("vld_mu_tight_iso_py8_pt", &ev.vld_mu_tight_iso_py8_pt);
  ...
  t_tree_->Branch("vld_mu_tight_py8_eta", &ev.vld_mu_tight_py8_eta);
  t_tree_->Branch("vld_mu_tight_iso_py8_eta", &ev.vld_mu_tight_iso_py8_eta);
